        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section animate__fadeInCustom animate__delay-2s">
                    ...
                    <p>
                        <i class="fas fa-map-marker-alt"></i> الفرع الرئيسي: الخرطوم السجانه شرق البرج الماليزي عمارة
                        رقم 5 الشقه في الطابق الاول
                    </p>
                    <p>
                        <i class="fas fa-map-marker-alt"></i> فرع بورسودان: بورسودان حي الخليج مريم 2 عقار رقم 66 الطابق
                        الثالث
                    </p>

                    <p>
                        <i class="fas fa-phone-alt"></i>
                        <a href="tel:0915755505">0915755505</a> -
                        <a href="tel:0913730836">0913730836</a> -
                        <a href="tel:0112066669">0112066669</a>
                    </p>
                    <p>
                        <i class="fab fa-whatsapp"></i> <a href="https://wa.me/20112066669"
                            target="_blank">+20112066669</a>
                    </p>

                    <p>
                        <i class="fas fa-envelope"></i> <a
                            href="mailto:SESCC2026@sescc-sud.com">SESCC2026@sescc-sud.com</a>
                    </p>


                </div>
                <div class="footer-bottom animate__fadeInCustom">
                    <img src="{{ asset('frontend/logo DONE.png') }}"style="width:50%;" alt="">
